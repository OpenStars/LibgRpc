...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "src/proto/grpc/status/status.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
Status::Status()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_src_2fproto_2fgrpc_2fstatus_2fstatus_2eproto::InitDefaults();
  }
  SharedCtor();
